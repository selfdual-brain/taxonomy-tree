...
/**
  ...
  * </ul>
  */
trait ImmutableTaxonomyWithTagging {
  ...
  /**
    ...
    * It follows from ne nature of the tree that at most one such node can exist.
    *
  ...
  /**
    ...
    * @return new Taxonomy instance
    */
  def addNode(path: Treepath, tags: Seq[String] = List.empty): ImmutableTaxonomyWithTagging

  def addNode(pathSegments:String*): ImmutableTaxonomyWithTagging = this.addNode(Treepath(pathSegments.toList))
  ...
  /**
    ...
    * @return new Taxonomy instance
    */
  def removeSubtree(path: Treepath): ImmutableTaxonomyWithTagging

  def removeSubtree(pathSegments:String*): ImmutableTaxonomyWithTagging = this.removeSubtree(Treepath(pathSegments.toList))
  ...
  /**
    ...
    */
  @throws[NodeNotFound]
  def tag(tag: String, targetNode: Treepath): ImmutableTaxonomyWithTagging
  ...
  /**
    ...
    */
  @throws[NodeNotFound]
  def untag(tag: String, targetNode: Treepath): ImmutableTaxonomyWithTagging
  ...
  /**
    ...
    * @return new Taxonomy instance
    */
  def registerTag(tag: String): ImmutableTaxonomyWithTagging
  ...
  /**
    ...
    * @return new Taxonomy instance
    */
  def unregisterTag(tag: String): ImmutableTaxonomyWithTagging
  ...
  /**
    ...
    */
  @throws[UnknownTag]
  def addTagTranslation(tag: String, translation: StringWithLocale): ImmutableTaxonomyWithTagging
  ...
  /**
    ...
    */
  @throws[UnknownTag]
  def removeTagTranslation(tag: String, locale: Locale): ImmutableTaxonomyWithTagging
